...
public class BankAPI {
    ...
    public Integer getMoney(OfflinePlayer player) {
        YamlConfiguration configuration = this.fileManager.getConfig("plugins/System/bank.yml");
        int money = 0;
    ...
    public void setMoney(OfflinePlayer player, int amount) {
        ...
        this.fileManager.save(new File("plugins/System/bank.yml"), configuration);
    }
